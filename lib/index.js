...
export default class Timeline extends PureComponent {
  ...
  _renderEvent(rowData, rowID) {
    ...
    const lineStyle = rowData.lineStyle
      ? rowData.lineStyle
    ...
    return (<>
      <Dash style={{ width: 1, flexDirection: "column",marginLeft: 6,paddingLeft: 6}} dashLength={2} dashThickness={2} dashColor={lineColor} dashGap={2} dashStyle={{borderRadius: 100, overflow: 'hidden'}}  />
      <View
        style={[
          styles.details,
          opStyle,
  ...
  _renderDetail(rowData, rowID) {
    ...
    return (
      <View style={styles.container}>
        <Text
          style={[styles.title, this.props.titleStyle, rowData.titleStyle,{marginTop:-3,borderWidth:0}]}
          allowFontScaling={isAllowFontScaling}
        >
          {rowData.title}
        </Text>
      ...
      case "single-column-left":
        circleStyle = isRtl
          ...
          : {
              ...
              borderRadius: circleSize / 2,
              backgroundColor: circleColor,
              left: this.state.x - circleSize / 2 + (lineWidth) / 2,
              borderWidth:0,              
            };
        break;
      case "single-column-right":
...
const styles = StyleSheet.create({
  ...
  detail: {marginTop:0 ,paddingTop: 0, paddingBottom: 0,borderWidth:0,zIndex:1000,marginLeft:12 },
  description: {
    marginTop: 3,
  },
  separator: {
